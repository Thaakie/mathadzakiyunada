    ...
    <section id="contact" className="py-16">
      <div className="max-w-[1100px] mx-auto px-8">
        ...
        <div className="contact-social-links flex justify-center gap-6 mb-12">
          <a href="https://www.linkedin.com/in/m-atha-dzaki-yunada-35052131a/" data-name="LinkedIn" target="_blank" rel="noopener noreferrer" className="text-[#2b2b2b] no-underline">
          ...
          <a href="https://github.com/Thaakie" data-name="GitHub" target="_blank" rel="noopener noreferrer" className="text-[#2b2b2b] no-underline">
